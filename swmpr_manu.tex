...
{\centering \includegraphics[width=0.8\textwidth]{figure/smooth_ex-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/interp_ex-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/decomp_ex1-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/decomp_ex2-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/summary_ex-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/metab_ex-1} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/map_ex-1} 
...
%latex.default(to_tab[, "Description", drop = F], file = "", caption = "Miscellaneous functions available from the \\pkg{SWMPr} package.  Most are used within the main functions above but may be useful for customized evaluations of SWMP data.  Full documentation for each function is in the help file (e.g., execute \\code{?calckl} at the command line).",     rowlabel = "Function", colheads = "Description", rowname = to_tab$Functions,     caption.loc = "top", col.just = c("p{3.5in}"), label = "tab:misc",     table.env = FALSE, where = "!tbp")%
\begin{table}[!tbp]
\caption{Miscellaneous functions available from the \pkg{SWMPr} package.  Most are used within the main functions above but may be useful for customized evaluations of SWMP data.  Full documentation for each function is in the help file (e.g., execute \code{?calckl} at the command line).\label{tab:misc}} 
\begin{center}
\begin{tabular}{lp{3.5in}}
\hline\hline
\multicolumn{1}{l}{Function}&\multicolumn{1}{c}{Description}\tabularnewline
\hline
\code{calckl}&Estimate the reaeration coefficient for air-sea gas exchange.  Used in the \code{ecometab} function.\tabularnewline
\code{metab\_day}&Identify the metabolic day for each approximate 24 period in an hourly time series.  Used in the \code{ecometab} function.\tabularnewline
\code{param\_names}&Returns column names as a list for the parameter types (nutrients, weather, or water quality).  Includes QAQC columns with \code{f\_} prefix. Used in the data retrieval functions.\tabularnewline
\code{parser}&Parses HTML returned from CDMO data requests.  Used in the retrieval functions.\tabularnewline
\code{swmpr}&Creates a \code{"swmpr"} object class.  Used in the data retrieval functions.\tabularnewline
\code{time\_vec}&Converts time vectors to \code{POSIXct} objects with the appropriate time zone for a site.  Used in the data retrieval functions.\tabularnewline
\hline
\end{tabular}\end{center}
...
{\centering \includegraphics[width=0.8\textwidth]{figure/metab_plo-1} 
