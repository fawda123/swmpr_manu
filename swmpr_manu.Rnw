...
<<eval = T, fig.height = 6, warning = F, cache = T>>=
# get data
data(apacpnut)
dat <- apacpnut
...
<<fig.height = 5, message = F, cache = T>>=
...
<<fig.height = 7, fig.width = 13, message = F, cache = T>>=
## import data
data(apacpnut)
dat <- qaqc(apacpnut)
...
<<eval = TRUE, cache = TRUE, fig.height = 4, fig.width = 8, warning = FALSE>>=
