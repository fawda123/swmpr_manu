...
descrips <- c(
  ...
  'View a summary of the number of observations in a \\texttt{swmpr} object that are assigned to different \\gls{QAQC} flags used by \\gls{CDMO}.  The output can be used to inform further processing.', 
